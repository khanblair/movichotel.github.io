...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>MOVIC HOTEL,</p>
				<p>Bwera Customs,<br>Kasese,<br>Uganda.</p>
				<p>(+256) 34567890s</p>
			</address>
			<span><img alt="" src="assets/img/sp.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@movichotel.com || Web :- www.movichotel.com || Phone :- +256 34567890 </p>
			</div>
		</aside>
	</body>
</html>
